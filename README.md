...
This fork contains the cubic spline algorithm converted for C#.

Just copy and use the CubicSpline.cs as follows:
...
The rest of the C++ repository information is left untouched.
